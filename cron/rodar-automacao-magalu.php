 ...
 * Se magalu_cron_token estiver preenchido nas configs, ?token= é obrigatório (apenas via web).
 */
$wantJson = false;
...
$tokenConfig = getConfig('magalu_cron_token', '');
...
$result = runAutomacaoMagalu(false);
